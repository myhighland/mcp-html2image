...
export async function captureHtmlToImage(options: Omit<CaptureOptions, 'url' | 'waitUntil' | 'timeout'>): Promise<string> {
...
export async function captureUrlToImage(options: Omit<CaptureOptions, 'html'>): Promise<string> {
  if (!options.url) {
...
async function captureToImage(page: Page, options: Omit<CaptureOptions, 'html' | 'url' | 'waitUntil' | 'timeout'>): Promise<string> {
